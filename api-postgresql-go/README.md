...
> [!NOTE]
> This sample is used in the [Deploy a Go PostgreSQL API Endpoint in SAP BTP, Kyma Runtimes](https://developers.sap.com/tutorials/cp-kyma-api-postgres-golang.html) tutorial.
