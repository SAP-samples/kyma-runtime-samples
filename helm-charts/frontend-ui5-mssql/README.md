This chart installs the example [frontend-ui5-postgresql](../../frontend-ui5-postgresql/README.md). Installing this chart will also install the charts [api-postgresql-go](../api-postgresql-go/README.md) and [database-postgresql](../database-postgres/README.md)   
