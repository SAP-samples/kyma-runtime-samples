This chart installs the example [frontend-ui5-postgresql](../../frontend-ui5-postgresql). Installing this chart will also install the charts [api-postgresql-go](../../api-postgresql-go/README.md) and [database-postgres](../../database-postgres/README.md)   
