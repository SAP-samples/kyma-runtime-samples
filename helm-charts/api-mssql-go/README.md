This chart installs the example [api-postgresql-go](../../api-postgresql-go/README.md) as well as it's dependency [database-postgres](../database-postgres/README.md)
